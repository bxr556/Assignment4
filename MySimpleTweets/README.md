# Project 3 - *My Tweet Client*

**My Tweet Client** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://developer.twitter.com/en/docs/api-reference-index).
...
<img src='https://i.imgur.com/KKFKe8m.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
